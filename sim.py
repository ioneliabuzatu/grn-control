...
class Sim:
    ...
    def get_half_response(self, gene_adjacency, cell_mean_expression):
    ...
    def init_regulated(self, gene_adjacency, half_response, concentration_dict):
        return self.hill_functions_sum(gene_adjacency, half_response, concentration_dict)/self.decay_lambda
    ...
    def hill_functions_sum(self, gene_adjacency, half_response, concentration_dict):
        ...
        # reduced_half_response = jnp.take(half_response, nonzero_indices) # Expected to be gene dependent
        ...
        reduced_half_response = jnp.take(half_response, jnp.array(kept_indices)) # Expected to be gene dependent
        ...
        # print(reduced_half_response.shape)
        # raise SystemExit(0)
